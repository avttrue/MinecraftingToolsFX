...
/**
 * Хэндлер покидания игроком канала
 */
public class ChatPartHandler implements UnpackedObjectTypeHandler
{
    ...
    {
        logger.log(Level.INFO, String.format("ChatPart.create: %1$d", objectId));
        ...
        Runnable SendDataToApplication = () -> {
            ...
            mcMessage.type = MC_Message.OUTCOMING;
            ...
            Map <Integer, DataValue> packedProperties)
    {
        ...
        logger.log(Level.INFO, String.format("ChatPart.update: %1$d", objectId));
    ...
    {
        logger.log(Level.INFO, String.format("ChatPart.destroy: %1$d", objectId));
