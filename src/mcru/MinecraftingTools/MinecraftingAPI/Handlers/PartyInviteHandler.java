...
/**
 * Хэндлер для приглашения игрока в пати
 */
public class PartyInviteHandler implements UnpackedObjectTypeHandler
{
    ...
    {
        logger.log(Level.INFO, String.format("PartyInvite.create: %1$d", objectId));
            ...
            Map <Integer, DataValue> packedProperties)
    {
        ...
        logger.log(Level.INFO, String.format("PartyInvite.update: %1$d", objectId));
    ...
    {
        logger.log(Level.INFO, String.format("PartyInvite.destroy: %1$d", objectId));
