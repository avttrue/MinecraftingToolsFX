...
/**
 * Хэндлер для выхода из пати
 */
public class PartyLeaveHandler implements UnpackedObjectTypeHandler
{
    ...
    {
        logger.log(Level.INFO, String.format("PartyLeave.create: %1$d", objectId));
            ...
            Map <Integer, DataValue> packedProperties)
    {
        ...
        logger.log(Level.INFO, String.format("PartyLeave.update: %1$d", objectId));
    ...
    {
        logger.log(Level.INFO, String.format("PartyLeave.destroy: %1$d", objectId));
